# go-agents-orchestration Examples

This directory contains comprehensive examples demonstrating the orchestration capabilities built on top of [go-agents](https://github.com/JaimeStill/go-agents).
...
**Solution:**
```bash
docker exec go-agents-ollama ollama list  # Check available models
docker exec go-agents-ollama ollama pull llama3.2:3b  # Pull if missing
```
...
- **Bug reports:** Open issue at https://github.com/JaimeStill/go-agents-orchestration/issues

## License

All examples are part of the go-agents-orchestration project and follow the same license as the main repository.
